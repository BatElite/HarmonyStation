...
/datum/component/consume/can_eat_inedible_organs/Initialize(var/can_eat_heads)
	...
	RegisterSignal(parent, COMSIG_ITEM_CONSUMED_PRE, PROC_REF(is_it_organs))
...
/datum/component/consume/organpoints/Initialize(var/target_abilityholder)
	...
	RegisterSignal(parent, COMSIG_ITEM_CONSUMED, PROC_REF(eat_organ_get_points))
...
/datum/component/consume/organheal/Initialize(var/mod_mult)
	...
	RegisterSignal(parent, COMSIG_ITEM_CONSUMED, PROC_REF(eat_organ_get_heal))
...
/datum/component/consume/food_effects/Initialize(var/list/_status_effects)
	...
	RegisterSignals(parent, list(COMSIG_ITEM_CONSUMED_PARTIAL, COMSIG_ITEM_CONSUMED_ALL), PROC_REF(apply_food_effects))
