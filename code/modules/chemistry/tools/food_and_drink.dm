...
/obj/item/reagent_containers/food
	...
	attackby(obj/item/W, mob/user)
		if (src.sliceable && istool(W, TOOL_CUTTING | TOOL_SAWING))
			...
			var/obj/item/reagent_containers/food/snacks/ingredient/sliced/pile = new src.slice_product(T, SLICING_AMT_REFERENCE)
			src.reagents.trans_to(pile, src.reagents.total_volume)
