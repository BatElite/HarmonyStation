...
/obj/item/shipcomponent/secondary_system/cloak
	...
	activate()
		...
		shield = image("icon" = 'icons/obj/vehicles/ship.dmi', "icon_state" = "shield", "layer" = MOB_LAYER)
...
/obj/item/shipcomponent/secondary_system/tractor_beam
	...
	activate()
		...
		if(!target)
			deactivate()
			return
		tractor = image("icon" = 'icons/obj/vehicles/ship.dmi', "icon_state" = "tractor", "layer" = FLOAT_LAYER)
